...
public class Tictactoe extends JFrame {
   ...
   // this is simply for drawing the board like height width etc.
   // Named-constants of the various dimensions used for graphics drawing
   public static final int CELL_SIZE = 100; // cell width and height (square) like 10*10
   public static final int CANVAS_WIDTH = CELL_SIZE * COLS;  // the drawing canvas 10*3
   public static final int CANVAS_HEIGHT = CELL_SIZE * ROWS; //10*3
   ...
   // taking Variables for checking the status of the game
      ...
      public void paintComponent(Graphics g) {  // invoke via repaint()
         ...
         if (currentState == GameState.PLAYING) {
            ...
            if (currentPlayer == Seed.CROSS) {
               ...
               statusBar.setText("Rajnish Your Turn");
            }
            ...
            statusBar.setForeground(Color.RED);
            statusBar.setText("Congrats X Won! Click to play again.");
         } else if (currentState == GameState.NOUGHT_WON) {
            statusBar.setForeground(Color.RED);
            statusBar.setText("Congrats rajnish' Won! Click to play again.");
         }
      }
   }
